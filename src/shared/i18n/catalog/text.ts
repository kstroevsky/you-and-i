export const TEXT = {
  ...
  ukrainian: {
    ...
    jumpPathHint: 'Ця підсвічена шашка може продовжувати стрибати, доки є наступна ціль.',
    clear: 'Скинути',
    trayActions: 'Ходи',
    trayInfo: 'Інфо',
    gameTraySectionsLabel: 'Секції ігрової панелі',
    glossaryHint: 'Використовуйте кнопки ? для коротких пояснень правил та підрахунку.',
    ...
    pwaUpdateReady: 'Готова нова версія. Оновіть застосунок, коли поточний хід можна безпечно перервати.',
